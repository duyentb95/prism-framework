...
- Test coverage gaps where adding the missing tests is straightforward (e.g., missing negative-path tests, missing edge case tests that mirror happy-path structure)
...
This heuristic is referenced by both `/code-review` and `/ship`. It determines whether
